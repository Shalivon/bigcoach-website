  ...
  return (
    <section id="method">
      ...
      <div className="method-head reveal">
        ...
        <p className="sec-sub">
          לא קסם ולא כוח רצון. שיטה עם שלוש רגליים, וכל אחת מהן סוגרת את הפינה שבה נפלת בפעם הקודמת.
        </p>
      </div>
